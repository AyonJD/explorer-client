...
const ArticleDetails = () => {
  ...
  useEffect(() => {
    fetch(`floating-ocean-13139.herokuapp.com/blogs/${articleId}`)
      .then((res) => res.json())
  ...
  // useEffect(() => {
  //   if (user) {
  //     fetch(`floating-ocean-13139.herokuapp.com/favourite/${user.uid}`)
  //       .then((res) => res.json())
  //       .then((data) => {
  ...
  //     if (favourite) {
  //       fetch(
  //         `floating-ocean-13139.herokuapp.com/favourite/${user.uid}`,
  //         {
  //           method: "DELETE",
  //           headers: {
