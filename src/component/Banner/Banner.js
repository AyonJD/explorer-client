        ...
        <section className='mid-container relative banner absolute '>
            <div className=' grid lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1 '>
                <div className='flex justify-center items-center'>
                    <div>
                        <span className='bg-neutral p-2 rounded-2xl text-warning'><button class="btn btn-xs btn-primary">New</button> Becoming a new program online</span>
            ...
            <div className="card lg:w-2/5 bg-neutral shadow-xl p-10 absolute lg:bottom-[-90px] md:bottom-[-120px] bottom-[-180px] border-t-8 border-primary border">
