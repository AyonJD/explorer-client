...
const PostArticle = () => {
  ...
  return (
    <div>
      <form
        className="mt-10 text-3xl md:w-1/2 w-3/4 mx-auto text-center"
      ...
      >
        ...
        <div className="form-control w-full">
          ...
          <select
            className="select select-bordered focus:outline-none overflow-hidden w-full"
            {...register("access", {
              required: {
                value: true,
        ...
        <button
          className="hover:text-white text-white group bg-[#011e2e] hover:bg-transparent px-6 py-2 my-2 flex items-center text-lg font-bold custom_box_shadow"
          type="submit"
        >
          Add Article
